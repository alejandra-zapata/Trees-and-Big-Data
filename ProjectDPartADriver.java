...
public class ProjectDPartADriver {
	...
	private static void methodEvaluator() {
		...
		System.out.println(lotsOfDups.countEntriesNonRecursive(SMALL_NUM));
		
		lotsOfDups = new BinarySearchTreeWithDups<Integer>();
		for(int i=0; i<SIZE; i++) {
			lotsOfDups.add(LARGE_NUM);
		}
		System.out.println(lotsOfDups.countEntriesNonRecursive(LARGE_NUM));
		...
		System.out.println(lotsOfDups.countGreaterWithStack(LARGE_NUM));
		System.out.println(lotsOfDups.countGreaterWithStack(SMALL_NUM-1));
		...
		System.out.println(lotsOfDups.countGreaterRecursive(LARGE_NUM));
		System.out.println(lotsOfDups.countGreaterRecursive(SMALL_NUM-1));
